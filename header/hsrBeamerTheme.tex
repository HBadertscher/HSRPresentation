...
\setbeamercolor*{section in toc shaded}{fg=HSRSchwarz80}
...
\setbeamertemplate{footline}
{
	\pgfdeclareimage[width=2.5cm]{HSRLogo}{header/HSR_Logo_RGB_72.jpg}%
	\begin{beamercolorbox}[sep=1em,wd=\paperwidth,leftskip=0.5cm,rightskip=0.5cm]{HSRSchwarz}
		\hrule
		\vspace{0.55cm}
		\pgfbox[left,center]{\hspace{0.3cm}\pgfuseimage{HSRLogo}}
		\hfil
