...
\defbeamertemplate*{title page}{customized}[1][]{
    ...
    \begin{tikzpicture}[remember picture,overlay,shift=(current page.south west)]
        ...
        \node[anchor=south west,inner sep=0] at (4.5mm,4.5mm) {\includegraphics[width=30mm]{header/HSR_Logo_CMYK.eps}};
...
\setbeamertemplate{footline}
{
    \begin{tikzpicture}
        ...
        \node[inner sep=0pt,anchor=west] at (1em,0.6cm)  {\includegraphics[width=2.5cm]{header/HSR_Logo_CMYK.eps}};
